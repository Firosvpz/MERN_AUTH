...
const SignUp = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-16 bg-white rounded-lg shadow-md overflow-hidden">
  <h1 className="text-2xl font-bold mb-4 text-center py-4 bg-gray-600 text-white">Sign Up</h1>
  ...
  <div className="py-3 text-center">
    <p className="text-sm text-gray-600">
      ...
      <Link to={`/login`} className="text-indigo-600 hover:text-indigo-800 transition duration-300 ease-in-out">
        Login
      </Link>
    </p>
  </div>
